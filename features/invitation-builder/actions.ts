...
export async function saveEventStep(
  ...
  const parsed = eventStepSchema.safeParse({
    ...
    celebrantName: formData.get("celebrantName") ?? undefined,
    celebrantAge: formData.get("celebrantAge") ?? undefined,
  ...
  try {
    await prisma.invitation.update({
      ...
      data: {
        ...
        celebrantName: parsed.data.celebrantName ?? null,
        celebrantAge: parsed.data.celebrantAge ?? null,
