...
> = {
  ...
  "corporate-precision": {
    ...
    foreground: "#101820",
    accent: "#b67b38",
    headingFont: "'Arial Narrow', 'Segoe UI', sans-serif",
    bodyFont: "'Segoe UI', system-ui, sans-serif",
    backgroundStyle: "bordered",
    decorativeStyle: "none",
  },
  "digital-light": {
    ...
    foreground: "#f8f8ff",
    accent: "#8e7cff",
    headingFont: "'Arial Black', 'Segoe UI Black', sans-serif",
  ...
  "starlight-dreamscape": {
    ...
    accent: "#ff8fdf",
    headingFont:
      "'Segoe Script', 'Brush Script MT', 'Iowan Old Style', Georgia, serif",
    bodyFont: "Inter, 'Segoe UI', system-ui, sans-serif",
    backgroundStyle: "soft-gradient",
    decorativeStyle: "starlight",
  },
};
