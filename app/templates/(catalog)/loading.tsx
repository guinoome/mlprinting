    ...
    <div>
      ...
      <div className="flex gap-8">
        ...
        <div className="min-w-0 flex-1">
          ...
          {/* Tracks the catalogue's grid exactly, including the card's three
              text lines (name, occasion, description). When the two drift the
              layout jumps as results land, which is the one thing a skeleton
              exists to prevent. Eight fills two rows of four. */}
